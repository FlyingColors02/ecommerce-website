...
import {LoginAction, LoggedInAction} from "../../../Store/actions/User/Authentication/authenticationAction";
                        ...
                        <div className="login-form">
                            ...
                            <div className="main-div">
                                ...
                                <div className="bottom-registration">
                                    ...
                                    <button type="button" className="registration-button "><Link to="/registration" className="registration-button-text">Create Your amYflip Account</Link></button>
                                </div>
                            </div>
