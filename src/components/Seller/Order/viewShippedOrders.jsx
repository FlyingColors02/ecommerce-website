...
import { ViewShippedOrderAction} from "../../../Store/actions/Seller/Order/orderAction";
import "../../User/Cart/Cart.css";

class ViewShippedOrder extends Component { 
                ...
                <div key={data._id}>
                    ...
                    <h5>
                        ...
                        <div style={{textAlign:"center",paddingTop:"10px"}}>
                            {
                                data.payedSeller === true ? <h5>ACCOUNT CLEARED</h5>
                                :data.shipped === true ? <h5 style={{color:"green"}}>Successfully Shipped</h5>:null
                            }
...
const mapStateToProps = (state) => {
    ...
    return { 
        ...
        loading: state.shippedOrder.loading,
        order: state.shippedOrder.data
    };
    
}
export default connect(mapStateToProps, { ViewShippedOrderAction})(ViewShippedOrder);
